        ...
        <div class="d-flex justify-content-center align-items-center full-height pt-5 mt-5">
            <div class="card text-light" style="width: 22rem; background: #121212;">
                <div class="card-body text-center"> <!-- Added text-center for centering content -->
                    ...
                    <form action="/Week-1-Project-Waltenberg/public/login" method="POST">
                        <div class="mb-3">
                        ...
                        <div class="mt-3 text-center">
                            <small>Don't have an account? <a href="/Week-1-Project-Waltenberg/public/register" class="text-light" style="text-decoration: none;">Sign up</a></small>
                        </div>
                    </form>
                </div>
            </div>
