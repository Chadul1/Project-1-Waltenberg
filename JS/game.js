...
const textNodes = [
    ...
    {
        id:302,
        text: "Appendix - \"Do not listen to this imposter organ, this \"Gut\" will be the end of you.\" \n \n Gut - \"Ignore this guy, he's a few cards short of a deck.\"",
        options: [
            {
    ...
    {
        id:401,
        text: "Gut - \"Are you actually believing that moron?\" Appendix - \"Silence! I am Förstöraren. His lordship has chosen to heed my words. Back! Back! to the pit.\" Your stomach growls and goes silent. \n Appendix - \"Anyway, where were we?\"  ",
        options: [
            {
                text: "\"Starving?\"",
                nextText: 402
    ...
    {
        id:501,
        text: "Appendix - \"Don't deny the Truth\" Gut - \"Silence. Return from whence you came.\" And with a gurgle, whatever influence it had upon you passed",
        options: [
            {
